...
from ..models.ranger import Rangers
from ..database import db_dependency
from ..schemas.ranger_schema import *
...
async def edit_ranger(db:db_dependency,new_name:str,ranger_uuid:str):
    ...
    db_ranger.ranger_name=new_name
    db.commit()
    db.refresh(db_ranger)
